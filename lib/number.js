...
export default function Footer() {
  return (
    ...
    >
      ...
      <h1 style={{ 
        marginBottom: "20px", 
        fontSize: "48px",          // تكبير حجم الخط بشكل ملحوظ
        fontWeight: "900",          // جعل الخط عريضاً جداً (Extra Bold)
        width: "100%",              // جعل العنوان يأخذ عرض الصفحة
        textTransform: "uppercase", // لجعل الحروف الإنجليزية كبيرة ومميزة
        letterSpacing: "1px"        // مسافة بسيطة بين الحروف لجمالية التصميم
      }}>
        Menu is over <br /> 
        <span style={{ fontSize: "56px" }}>المنيو انتهى</span>
      </h1>
